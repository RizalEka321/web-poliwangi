<template>
  <div class="px-6 md:px-20 py-10 space-y-10">
    ...
    <section class="">
      ...
      >
        Laporan keuangan Politeknik Negeri Banyuwangi disusun berdasarkan sistem
      ...
      <ul
        class="list-decimal list-outside pl-5 space-y-1 text-justify text-[var(--text-black)] mt-5"
        style="font-family: var(--font-albert)"
      >
      ...
      <p
        ...
        style="font-family: var(--font-albert)"
      >
        Laporan Keuangan Politeknik Negeri Banyuwangi disusun tiap semester dan
        triwulan dengan mengacu pada Peraturan Pemerintah Nomor 71 Tahun 2010
        tentang Standar Akuntansi Pemerintah dan Kaidah-kaidah Pengelolaan
        Keuangan yang Sehat dalam Pemerintahan. Laporan Keuangan Politeknik
        Negeri Banyuwangi telah disusun dan disajikan dengan basis akrual
