<template>
  <div class="px-6 md:px-20 py-10 space-y-10">
    ...
    >
      ...
      <div
        class="absolute inset-0 flex flex-col items-start justify-center ps-10"
        style="font-family: var(--font-lora)"
      >
        <h1 class="text-3xl md:text-5xl font-bold text-white text-center mb-2">
          Kerjasama
        </h1>
        <h2 class="text-3xl md:text-5xl font-bold text-white text-center">
    ...
    <section class="kerjasama">
      ...
      >
        <div class="flex flex-col justify-center gap-4 mb-4">
          <h2
            class="text-xl md:text-2xl font-bold text-[var(--blue-dark)]"
            style="font-family: var(--font-lora)"
          >
            Rekapitulasi Kerjasama Politeknik Banyuwangi 2025
          </h2>
        </div>
...
const kerjasama = [
  {
    ...
    kegiatan:
      "Kerjasama bidang penelitian dan pengabdian kepada masyarakat, peningkatan kualitas sumber daya manusia, dan kerja praktek/magang kerja industri mahasiswa.",
    mulai: "2 Juni 2022",
    berakhir: "2 Juni 2027",
    bentuk:
      "Tri dharma perguruan tinggi, Pengembangan iptek, Magang Kerja Industri, Beasiswa pendidikan mahasiswa.",
  ...
  },
  {
    ...
    kegiatan:
      "Penyediaan, Pemanfaatan, serta Pengembangan Data dan Informasi Statistik dalam Rangka Penyelenggaraan Tri Dharma Perguruan Tinggi.",
    mulai: "15 Februari 2024",
    berakhir: "15 Februari 2027",
    bentuk:
      "Pemanfaatan data statistik melalui Pojok Statistik Poliwangi, Magang Kerja, pelatihan statistik bagi mahasiswa.",
  ...
  },
  {
    ...
    kegiatan:
      "Peningkatan Pembangunan Daerah dan Peningkatan Kualitas Sumber Daya Manusia melalui Tridharma Perguruan Tinggi.",
    mulai: "17 Mei 2022",
    berakhir: "17 Mei 2025",
    bentuk:
      "Bantuan operasional lembaga, bantuan beasiswa kepada mahasiswa, dan pengembangan IPTEKS.",
    jenis: "Instansi Dalam Negeri",
  },
  {
    no: 4,
    ...
    kegiatan:
      "Kerjasama dalam bidang implementasi tri dharma perguruan tinggi dan peningkatan kualitas sumber daya manusia.",
    mulai: "1 Maret 2024",
    berakhir: "1 Maret 2029",
    bentuk:
      "Penyesuaian kurikulum, penggunaan sarana dan prasarana praktek mahasiswa, pemanfaatan tenaga ahli sebagai dosen tamu.",
    jenis: "Instansi Dalam Negeri",
  },
  {
    no: 5,
    ...
    kegiatan:
      "Kerjasama pelaksanaan kerja praktik / magang industri di Malaysia",
    mulai: "1 Januari 2025",
    berakhir: "31 Desember 2026",
    bentuk:
      "Mengirimkan mahasiswa poliwangi untuk pelaksanaan magang kerja praktek di Malaysia selama 6 bulan/ semester",
  ...
  },
  {
    ...
    kegiatan:
      "Kerjasama dalam Pertukaran pelajar, pertukaran fakultas, program akademik khusus jangka pendek, pengembangan staf, dan joint research.",
    mulai: "13 Desember 2023",
    berakhir: "13 Desember 2028",
    bentuk:
      "Menyalurkan beasiswa studi lanjut di Taiwan kepada mahasiswa, dan bekerjasama dengan industri Taiwan menyerap lulusan baru.",
    jenis: "Instansi Dalam Negeri",
  },
  {
    no: 7,
    ...
    kegiatan:
      "Kerjasama dalam bidang Implementasi Tri Dharma Perguruan Tinggi, Peningkatan Kualitas Sumber Daya Manusia, dan Penyerapan lulusan.",
    mulai: "9 November 2022",
    berakhir: "9 November 2027",
    bentuk:
      "Penyerapan lulusan, pemanfaatan tenaga ahli dalam perkuliahan, penggunaan sarana dan prasarana.",
    jenis: "Industri Dalam Negeri",
  },
];
