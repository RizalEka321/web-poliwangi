<template>
    ...
    <div ref="cardContainer" class="overflow-x-hidden py-3 px-4 md:px-20">
      ...
      >
        ...
        >
          ...
          ></div>
          <div
            class="relative z-10 p-4 text-white flex flex-col justify-end h-full"
          >
        ...
        >
          <a href="/" class="flex gap-4 items-stretch w-full">
            ...
            <div class="flex-1">
              ...
              <p class="text-sm text-justify leading-[1.2rem]">
                {{ item.description }}
              </p>
            </div>
          </a>
  ...
  <section class="event my-10">
    ...
    <div
      class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 px-4 md:px-20"
    >
      <div
...
const registrationData = [
  {
    title: "SNBP",
    description:
      "Pendaftaran Seleksi Nasional Berdasarkan Prestasi (SNBP) merupakan jalur seleksi penerimaan mahasiswa baru berdasarkan capaian akademik siswa selama di sekolah, dengan memperhatikan prestasi lain yang relevan.",
    link: "/snbp",
    date: "15 Januari 2025",
  },
  {
    title:
      "PENGUMUMAN HASIL SELEKSI MAHASISWA BARU PENERIMA BEASISWA KIPK JALUR SNBT TAHUN 2024",
    description:
      "Berdasarkan hasil seleksi Tim Pengelola Beasiswa Kartu Indonesia Pintar Kuliah (KIPK) Jalur Seleksi Nasional Berdasarkan Tes (SNBT) Politeknik Negeri Banyuwangi...",
    link: "/utbk-snbt",
    date: "9 Juli 2024",
  },
  {
    title: "Mandiri",
    description:
      "Jalur Mandiri memberikan kesempatan kepada calon mahasiswa untuk mendaftar secara langsung ke Poliwangi dengan mempertimbangkan hasil tes mandiri yang diselenggarakan kampus.",
    link: "/mandiri",
    date: "10 Maret 2025",
  },
  {
  ...
  },
  {
    title: "Profesi",
    description:
      "Program Profesi dirancang untuk menyiapkan lulusan yang memiliki sertifikasi keahlian profesional sesuai dengan standar industri dan dunia kerja.",
    link: "/profesi",
    date: "18 April 2025",
  },
  {
    ...
    description:
      "Program Transfer Kredit memungkinkan mahasiswa memindahkan sebagian mata kuliah dari perguruan tinggi asal ke Poliwangi, sehingga mempersingkat masa studi.",
  ...
  },
  {
    title: "Beasiswa Lain",
    description:
      "Berbagai jenis beasiswa tersedia di Poliwangi untuk mendukung mahasiswa berprestasi maupun yang membutuhkan bantuan biaya pendidikan.",
    link: "/beasiswa-lain",
    date: "1 Mei 2025",
  },
];
...
const beritaList = [
  {
    ...
    date: "18 Juni 2025",
    description:
      "Mahasiswa Poliwangi mengikuti workshop intensif mengenai pengembangan bisnis, perencanaan usaha, serta strategi.",
  },
  {
    title:
      "Kunjungan Industri Mahasiswa Teknik Poliwangi ke PT XYZ untuk Mendalami Proses Produksi Modern",
    date: "15 Juni 2025",
    description:
  ...
  {
    title:
      "Sosialisasi Program Magang Industri Bagi Mahasiswa Poliwangi Sebelum Lulus ke Dunia Kerja",
    date: "10 Juni 2025",
    description:
